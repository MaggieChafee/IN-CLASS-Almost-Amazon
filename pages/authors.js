...
const emptyAuthors = () => {
  const domString = '<h3>No Authors Found</h3>';
    ...
    domString += `
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <p class="card-text bold">${item.favorite ? `<span><i class="fa-solid fa-heart" aria-hidden="true" style="color: #ff7ae2;"></i></span> ${''}` : `${''}`}</p>
          <hr>
